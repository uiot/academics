...
if (isset($_POST['do'])):
    ...
    StateVariableMapper::save($state_variable);

    $text['title'] = "Add State Variable";
    $text['message'] = "State Variable Added Successfully";
...
BOX;
    ...
    $form = new Forms('Add State Variable', '/statevariable/add/');
    $form->add_header('General Configuration');
    $form->add_hidden([
        'name' => 'do', 'value' => 'state_variable_add'
    ]);
    $form->add_input([
        'type' => 'text', 'name' => 'name', 'class' => 'replace_space', 'placeholder' => 'the new state variable name', 'maxlength' => 30, 'value' => ''
    ...
    $form->add_select([
        'class' => 'replace_space', 'value' => '', 'name' => 'data_type'
    ], [
        [
    ...
    $form->add_select([
        'class' => 'replace_space', 'value' => '', 'name' => 'send_events'
    ], [
        [
            "value" => 'yes', "label" => 'Yes'
        ], [
    ...
    $form->add_select([
        'class' => 'replace_space', 'value' => '', 'name' => 'multicast'
    ], [
        [
            "value" => 'yes', "label" => 'Yes'
        ], [
    ...
    $form->add_input([
        'type' => 'text', 'name' => 'default_value', 'class' => 'replace_space', 'placeholder' => 'the new state variable default value', 'maxlength' => 30, 'value' => ''
    ], 'Default Value', 'please put a default value');
    $form->add_header('Reading circuit configuration');
    $form->add_input([
        'type' => 'text', 'name' => 'reading_circuit_pin', 'class' => 'replace_space', 'placeholder' => 'the new state variable pin id', 'maxlength' => 30, 'value' => ''
    ], 'Reading Circuit Pin', 'please put a circuit pin id');
    $form->add_select([
        'class' => 'replace_space', 'value' => '', 'name' => 'reading_circuit_type'
    ], [
        [
    ...
    $form->add_select([
        'class' => 'replace_space', 'value' => '', 'name' => 'reading_circuit_baudrate'
    ], [
        [
            "value" => '0', "label" => '0'
        ], [
    ...
    $form->add_input([
        'type' => 'text', 'name' => 'writing_circuit_pin', 'class' => 'replace_space', 'placeholder' => 'the new state variable pin id', 'maxlength' => 30, 'value' => ''
    ], 'Writing Circuit Pin', 'please put a circuit pin id');
    $form->add_select([
        'class' => 'replace_space', 'value' => '', 'name' => 'writing_circuit_type'
    ], [
        [
            "value" => 'DIGITAL', "label" => 'Digital'
        ], [
    ...
    $form->add_select([
        'class' => 'replace_space', 'value' => '', 'name' => 'writing_circuit_baudrate'
    ], [
        [
            "value" => '0', "label" => '0'
        ], [
