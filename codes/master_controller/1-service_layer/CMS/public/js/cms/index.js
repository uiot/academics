    ...
    var that = {
        ...
        switchMode: function (e) {
            if (e.mode == 'hidden') {
                ...
                dom.stop(true).css('opacity', 0).show().fadeTo(
                    e.dt, 1, function () {
                        that.resize()
                    }
                )
        ...
        switchSection: function (newSection) {
            ...
            var children = $.map(
                sys.getEdgesFrom(newSection), function (edge) {
                    return edge.target
                }
            )
                ...
                dblclicked: function (e) {
                    ...
                    if (nearest && selected && nearest.node === selected.node) {
                        ...
                        if (link.match(/^#/)) {
                            ...
                            $('#linkContent').load(link);
                            $("a.close-reveal-modals").click(
                                function () {
...
$(document).ready(
    function () {
        ...
        $(".tree_button").click(function () {
            var myWin = window.open($(this).attr('link'), 'Quick View', []);
        });
    }
);
