...
<body
    style="/*background: -webkit-radial-gradient(center, ellipse cover, rgba(255,255,255,1) 40%,rgba(0,0,0,0.1) 100%);*/background: -webkit-radial-gradient(center, ellipse cover, rgba(255,255,255,1) 40%,rgba(0,0,0,0.15) 100%);">
    ...
    <div class="inner-wrap" style="min-height: 100%;">
        <nav class="tab-bar" style="height: 2.5rem;line-height: 2.5rem;z-index:1001;" id="Menu">
            <section class="left-small" id="Section2" style="height: 2.5rem;line-height: 2.5rem;">
                <a class="left-off-canvas-toggle menu-icon" style="height: 2.5rem;line-height: 2.5rem;" href="#"
                    ><span></span>
                </a>
            </section>
            <section class="right tab-bar-section" style="right:auto;height: 2.5rem;line-height: 2.5rem;"
                ...
                <h1 class="title" style="font-weight:normal;font-size: 0.94444rem;line-height: 2.5rem;"><b>UIoT</b>
                    cms
                    <span class="label regular" style="top:-2px;left:4px;">alpha</span></h1>
            </section>
            <section class="right top-bar-section" style="height: 2.5rem;line-height: 2.5rem;">
                <ul class="right">
                    <li class="active" id="addme" style="display:none;height: 2.5rem;">
                        <a href="../add/" style="height: 2.5rem;line-height: 2.5rem;">New</a>
                    </li>
                    <li class="active" id="addstore" style="display:none;height: 2.5rem;">
                        <a href="../../store/index" style="height: 2.5rem;line-height: 2.5rem;">New</a>
                    </li>
                    <li class="active" id="cancelme" style="display:none;height: 2.5rem;">
                        <a href="../list/" style="height: 2.5rem;line-height: 2.5rem;">Cancel</a>
                    </li>
                </ul>
            </section>
        </nav>
        <aside class="left-off-canvas-menu" style="background: #FAFAFA;box-shadow: 1px 1px 7px gray;z-index: 1000;">
            <ul class="off-canvas-list main_menu">
                <li><label>Welcome, <b><?php
                            $name = ucfirst(escape_text($_SESSION['u_real']));
